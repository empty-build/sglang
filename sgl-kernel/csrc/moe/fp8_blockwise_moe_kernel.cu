...
GENERATE_SM90_FP8_PP_CONFIG(64,128,256,1,1,1)
GENERATE_SM90_FP8_PP_CONFIG(64,128,256,1,1,2)
GENERATE_SM90_FP8_PP_CONFIG(64,128,256,1,2,1)
GENERATE_SM90_FP8_PP_CONFIG(64,128,256,1,2,2)
GENERATE_SM90_FP8_PP_CONFIG(64,128,256,1,4,1)
GENERATE_SM90_FP8_PP_CONFIG(64,128,256,1,4,2)
GENERATE_SM90_FP8_PP_CONFIG(64,128,256,2,1,1)
GENERATE_SM90_FP8_PP_CONFIG(64,128,256,2,1,2)
GENERATE_SM90_FP8_PP_CONFIG(64,128,256,2,2,1)
GENERATE_SM90_FP8_PP_CONFIG(64,128,256,2,2,2)
GENERATE_SM90_FP8_PP_CONFIG(64,128,256,2,4,1)
GENERATE_SM90_FP8_PP_CONFIG(64,128,256,2,4,2)
GENERATE_SM90_FP8_PP_CONFIG(64,128,256,4,1,1)
GENERATE_SM90_FP8_PP_CONFIG(64,128,256,4,1,2)
GENERATE_SM90_FP8_PP_CONFIG(64,128,256,4,2,1)
GENERATE_SM90_FP8_PP_CONFIG(64,128,256,4,2,2)
GENERATE_SM90_FP8_PP_CONFIG(64,128,256,4,4,1)
GENERATE_SM90_FP8_PP_CONFIG(64,128,256,4,4,2)
...
void sm90_fp8_blockwise_group_mm_dispatch_shape(
  ...
  if (tune_mode) {
    ...
    case 124111: {
    using execute_gemm_config = sm90_fp8_pp_config_64_128_256_1_1_1;
    run_get_group_gemm_starts<execute_gemm_config::LayoutSFA, execute_gemm_config::LayoutSFB, execute_gemm_config::ScaleConfig>(
        expert_offsets,
        a_ptrs,
        b_ptrs,
    ...
    case 124112: {
    using execute_gemm_config = sm90_fp8_pp_config_64_128_256_1_1_2;
    run_get_group_gemm_starts<execute_gemm_config::LayoutSFA, execute_gemm_config::LayoutSFB, execute_gemm_config::ScaleConfig>(
        expert_offsets,
        a_ptrs,
        b_ptrs,
    ...
    case 124121: {
    using execute_gemm_config = sm90_fp8_pp_config_64_128_256_1_2_1;
    run_get_group_gemm_starts<execute_gemm_config::LayoutSFA, execute_gemm_config::LayoutSFB, execute_gemm_config::ScaleConfig>(
        expert_offsets,
        a_ptrs,
        b_ptrs,
    ...
    case 124122: {
    using execute_gemm_config = sm90_fp8_pp_config_64_128_256_1_2_2;
    run_get_group_gemm_starts<execute_gemm_config::LayoutSFA, execute_gemm_config::LayoutSFB, execute_gemm_config::ScaleConfig>(
        expert_offsets,
        a_ptrs,
        b_ptrs,
    ...
    case 124141: {
    using execute_gemm_config = sm90_fp8_pp_config_64_128_256_1_4_1;
    run_get_group_gemm_starts<execute_gemm_config::LayoutSFA, execute_gemm_config::LayoutSFB, execute_gemm_config::ScaleConfig>(
        expert_offsets,
        a_ptrs,
        b_ptrs,
    ...
    case 124142: {
    using execute_gemm_config = sm90_fp8_pp_config_64_128_256_1_4_2;
    run_get_group_gemm_starts<execute_gemm_config::LayoutSFA, execute_gemm_config::LayoutSFB, execute_gemm_config::ScaleConfig>(
        expert_offsets,
        a_ptrs,
        b_ptrs,
    ...
    case 124211: {
    using execute_gemm_config = sm90_fp8_pp_config_64_128_256_2_1_1;
    run_get_group_gemm_starts<execute_gemm_config::LayoutSFA, execute_gemm_config::LayoutSFB, execute_gemm_config::ScaleConfig>(
        expert_offsets,
        a_ptrs,
        b_ptrs,
    ...
    case 124212: {
    using execute_gemm_config = sm90_fp8_pp_config_64_128_256_2_1_2;
    run_get_group_gemm_starts<execute_gemm_config::LayoutSFA, execute_gemm_config::LayoutSFB, execute_gemm_config::ScaleConfig>(
        expert_offsets,
        a_ptrs,
        b_ptrs,
    ...
    case 124221: {
    using execute_gemm_config = sm90_fp8_pp_config_64_128_256_2_2_1;
    run_get_group_gemm_starts<execute_gemm_config::LayoutSFA, execute_gemm_config::LayoutSFB, execute_gemm_config::ScaleConfig>(
        expert_offsets,
        a_ptrs,
        b_ptrs,
    ...
    case 124222: {
    using execute_gemm_config = sm90_fp8_pp_config_64_128_256_2_2_2;
    run_get_group_gemm_starts<execute_gemm_config::LayoutSFA, execute_gemm_config::LayoutSFB, execute_gemm_config::ScaleConfig>(
        expert_offsets,
        a_ptrs,
        b_ptrs,
    ...
    case 124241: {
    using execute_gemm_config = sm90_fp8_pp_config_64_128_256_2_4_1;
    run_get_group_gemm_starts<execute_gemm_config::LayoutSFA, execute_gemm_config::LayoutSFB, execute_gemm_config::ScaleConfig>(
        expert_offsets,
        a_ptrs,
        b_ptrs,
    ...
    case 124242: {
    using execute_gemm_config = sm90_fp8_pp_config_64_128_256_2_4_2;
    run_get_group_gemm_starts<execute_gemm_config::LayoutSFA, execute_gemm_config::LayoutSFB, execute_gemm_config::ScaleConfig>(
        expert_offsets,
        a_ptrs,
        b_ptrs,
    ...
    case 124411: {
    using execute_gemm_config = sm90_fp8_pp_config_64_128_256_4_1_1;
    run_get_group_gemm_starts<execute_gemm_config::LayoutSFA, execute_gemm_config::LayoutSFB, execute_gemm_config::ScaleConfig>(
        expert_offsets,
        a_ptrs,
        b_ptrs,
    ...
    case 124412: {
    using execute_gemm_config = sm90_fp8_pp_config_64_128_256_4_1_2;
    run_get_group_gemm_starts<execute_gemm_config::LayoutSFA, execute_gemm_config::LayoutSFB, execute_gemm_config::ScaleConfig>(
        expert_offsets,
        a_ptrs,
        b_ptrs,
    ...
    case 124421: {
    using execute_gemm_config = sm90_fp8_pp_config_64_128_256_4_2_1;
    run_get_group_gemm_starts<execute_gemm_config::LayoutSFA, execute_gemm_config::LayoutSFB, execute_gemm_config::ScaleConfig>(
        expert_offsets,
        a_ptrs,
        b_ptrs,
    ...
    case 124422: {
    using execute_gemm_config = sm90_fp8_pp_config_64_128_256_4_2_2;
    run_get_group_gemm_starts<execute_gemm_config::LayoutSFA, execute_gemm_config::LayoutSFB, execute_gemm_config::ScaleConfig>(
        expert_offsets,
        a_ptrs,
        b_ptrs,
    ...
    case 124441: {
    using execute_gemm_config = sm90_fp8_pp_config_64_128_256_4_4_1;
    run_get_group_gemm_starts<execute_gemm_config::LayoutSFA, execute_gemm_config::LayoutSFB, execute_gemm_config::ScaleConfig>(
        expert_offsets,
        a_ptrs,
        b_ptrs,
    ...
    case 124442: {
    using execute_gemm_config = sm90_fp8_pp_config_64_128_256_4_4_2;
    run_get_group_gemm_starts<execute_gemm_config::LayoutSFA, execute_gemm_config::LayoutSFB, execute_gemm_config::ScaleConfig>(
        expert_offsets,
        a_ptrs,
        b_ptrs,
