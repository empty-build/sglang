...
from sglang.bench_serving import benchmark, DatasetRow, set_global_args
...
def send_one_batch(base_url, num_prompts, batch_size):
    ...
    step_time = np.percentile(server_info["internal_states"][0]["step_time_dict"][str(batch_size)], 20)
