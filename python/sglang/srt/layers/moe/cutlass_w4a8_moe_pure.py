...
def cutlass_w4a8_moe_pure(
    ...
    assert a.shape[1] // 2 == w1_q.shape[2], f"a.shape[1]:{a.shape[1]} Hidden size mismatch w1 w1_q.shape[2]:{w1_q.shape[2]}"
    ...
    # print(f"a1_scale_reorder:{a1_scale} {a1_scale.device}")
    ...
    sgl_per_tensor_quant_fp8(a, a_q, a1_scale_float, True)
